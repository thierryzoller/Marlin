...
#define STRING_CONFIG_H_AUTHOR "(ZOLLER, BLTouch)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Zoller Thierry MOD"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.92, 79.92, 398.37, 443.8 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 449 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, -49, 0 }
...
#define XY_PROBE_FEEDRATE (150*40)
...
#define HOMING_FEEDRATE_MM_M { (50*65), (50*65), (5*60) }
